...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	?>
        ...
        <?php 
        $sql="select qid,categorie,ques,tans,fans1,fans2,fans3 from level1 where qid=".$qid;
				  ...
				  <tr>
		          	<td>
		          		...
		          		<?php if($randno==2)
		          		{
			            	...
			            	<td>
			            		<button id="fans3"  class="waves-effect waves-light btn-large" onclick="go3()"><?php echo $row["fans3"]?></button>
			            	</td>
			            	<td>
			            		<button id="fans1"  class="waves-effect waves-light btn-large" onclick="go1()"><?php echo $row["fans1"];?></button>
			            	</td>
			            	<td>
			            		<button id="fans2"  class="waves-effect waves-light btn-large" onclick="go2()"><?php echo $row["fans2"]?></button>
			            	</td>
			            	...
			            	<td>
			            		<img src="images/coin.jpg" id="imgcoin1"><?php echo " ";?><span id='f3'>0</span><br/>
			            	</td>
			            	<td>
			            		<img src="images/coin.jpg" id="imgcoin1"><?php echo " ";?><span id='f1'>0</span><br/>
			            	</td>
			            	<td>
			            		<img src="images/coin.jpg" id="imgcoin1"><?php echo " ";?><span id='f2'>0</span><br/>
			            	</td>
			          	...
			          	?>
			            	...
			            	<td>
		          				<button id="tans"  class="waves-effect waves-light btn-large" onclick="go()"><?php echo $row["tans"];?> </button>
			            	</td>
			            	<td>
			            		<button id="fans3"  class="waves-effect waves-light btn-large" onclick="go3()"><?php echo $row["fans3"]?></button>
			            	</td>
...
function go2()
{
	display3 = document.querySelector('#f2');
	if(c>0)
	{
		t3=t3+5;
		c=c-5;
		display3.textContent =   t3;
	    display.textContent= c;
	}
	else if(c<=0 && t3>0)
	{
...
function go3()
{
	display4 = document.querySelector('#f3');
	if(c>0)
	{
		t4=t4+5;
		c=c-5;
		display4.textContent =   t4;
	    display.textContent= c;
	}
	else if(c<=0 && t4>0)
	{
...
function startTimer(duration, displayt) {
  ...
  function nextlevel()
  {
	...
	setInterval(function(){
		document.getElementById("fans3").disabled=true;
	},2000);
	setInterval(function(){
		document.getElementById("fans2").disabled=true;
	},4000);
	setInterval(function(){
		...
		if(t1>0 && t2>0 && t3>0 && t4>0)
		{
				...
				document.write("<body>");
				document.write("<form action='categories2.php' method='post'>");
		...
		{
				alert("You Lost . No Money in Right Answer!");
				window.location="index.php";
		 }
	},6000);	
