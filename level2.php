...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        ...
        $sql="select qid,categorie,ques,tans,fans1,fans2,fans3 from level234 where qid=".$qid;
...
function startTimer(duration, displayt) {
  ...
  function nextlevel()
  {
		...
		if(t1>0 && t2>0 && t3>0 && t4>0)
		{
			...
			//$sqlleftcoin="update leftcoin set coin=".;
			//$conn->query($sqlleftcoin);
			setInterval(function(){
			displayt = document.querySelector('#time');
			displayt.textContent = "00";
			},2000);
				...
				document.write("<body>");
				document.write("<form action='categories3.php' method='post'>");
